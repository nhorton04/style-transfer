...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_interval", type=int, default=10000, help="Batches between saving model")
    ...
    image_samples = []
    for path in random.sample(glob.glob(f"{args.dataset_path}/*/*.jpg"), args.batch_size):
